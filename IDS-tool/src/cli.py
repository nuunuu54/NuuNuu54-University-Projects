...
def main():
    p = argparse.ArgumentParser(
        prog="ids", description="Simple IDS one-word CLI wrapper"
    )
    ...
    p_train.add_argument(
        ...
        help="Extra args forwarded to train module",
        default=None,
    )
    ...
    p_batch.add_argument(
        "extra",
        nargs=argparse.REMAINDER,
        help="Extra args forwarded to ids module",
        default=None,
    )
    ...
    p_pre.add_argument(
        "extra",
        nargs=argparse.REMAINDER,
        help="Extra args forwarded to precheck script",
        default=None,
    )
    ...
    p_merge.add_argument(
        "extra",
        nargs=argparse.REMAINDER,
        help="Extra args forwarded to ingest_merge",
        default=None,
    )
    ...
    p_tune.add_argument(
        "extra",
        nargs=argparse.REMAINDER,
        help="Extra args forwarded to tune module",
        default=None,
    )
    ...
    p_e2e.add_argument(
        "extra",
        nargs=argparse.REMAINDER,
        help="Extra args forwarded to e2e runner",
        default=None,
    )

    p_bulk = sp.add_parser(
        "bulk-train", help="Run quick bulk training over normalized datasets"
    )
    ...
    p_bulk.add_argument(
        "extra",
        nargs=argparse.REMAINDER,
        help="Extra args forwarded to train_quick",
        default=None,
    )

    p_report = sp.add_parser(
        "bulk-report", help="Run consolidated precheck+report (bulk_process)"
    )
    p_report.add_argument(
        "extra",
        nargs=argparse.REMAINDER,
        help="Extra args forwarded to bulk_process",
        default=None,
    )
